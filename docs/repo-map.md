...
## API Routes (`apps/api/main.py` — 2914 lines, 174 routes)
...
GET     /processes/{process_id}/diagram
POST    /processes/{process_id}/runs
GET     /processes/{process_id}/runs
POST    /processes/runs/{run_id}/advance
POST    /processes/runs/{run_id}/complete
GET     /files
GET     /files/{file_id}
DELETE  /files/{file_id}
POST    /documents/generate
GET     /okrs/{obj_id}/export
GET     /processes/{process_id}/export
GET     /documents
GET     /templates
...
POST    /okrs/key-results/{kr_id}/link-kpi
GET     /okrs/{obj_id}/hierarchy
POST    /okrs/{obj_id}/grade
GET     /okrs/overdue-checkins
